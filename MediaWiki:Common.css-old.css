...
.skin-citizen .mw-editform #wpTextbox1 {
	margin: 0;
	border: 0;
	background: linear-gradient(90deg, rgba(255,246,19,0.22030819163602944) 0%, rgba(174,255,0,0) 100%);
	padding: 0 2em;
    height: 100%
    padding: 0 1em;
    font-size: 90%;
...
/* load.php | https://wiki.ead.pucv.vm/load.php?lang=es&modules=site.styles&only=styles&skin=citizen */
